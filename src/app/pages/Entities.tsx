...
import { Search, Plus, Filter, Users, ChevronLeft, ChevronRight } from "lucide-react";
      ...
      <div className="h-full flex flex-col">
        ...
        <div className="flex-1 overflow-auto">
          {isLoading ? (
            ...
            <EmptyState
              icon={Users}
              title="No entity entries yet"
              description="Entity entries track projects, contacts, and tools. They help your AI agent understand who and what is involved in your work."
              actions={[
